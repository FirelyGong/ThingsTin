...
namespace Common.Controls
{
    ...
    public class GridLineDecorator : FrameworkElement
    {
        ...
        private void DrawGridLines()
        {
            ...
            int index = 0;
            var item0 = _target.ItemContainerGenerator.ContainerFromIndex(index);
            while (item0 == null && index < _target.Items.Count)
            {
                index++;
                item0 = _target.ItemContainerGenerator.ContainerFromIndex(index);
            }
